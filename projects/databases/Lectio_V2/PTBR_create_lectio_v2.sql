...
create table livro_genero (
    ...
    constraint fk_livrogenero_idlivro
        foreign key (id_livro) references livro(id_livro),
    constraint fk_livrogenero_idgenero
...
create table livro_autor (
    ...
    constraint fk_livroautor_idlivro
        foreign key (id_livro) references livro(id_livro),
    constraint fk_livroautor_idautor
...
create table livro_editora (
    ...
    constraint fk_livroeditora_idlivro
        foreign key (id_livro) references livro(id_livro),
    constraint fk_livroeditora_ideditora
...
create table livro_promocao (
    ...
    constraint fk_livropromocao_idlivro
        foreign key (id_livro) references livro(id_livro),
    constraint fk_livropromocao_idpromocao
...
create table usuario (
    ...
    senha_hash_usuario nvarchar(255) not null
);

create table colaboracao (
    id_colaboracao int primary key identity(1, 1),
    data_colaboracao datetime not null,
    tipo_colaboracao nvarchar(20) not null,
    status_colaboracao nvarchar(20) not null,
    id_usuario int not null,
    constraint fk_colaboracao_idusuario
...
create table biblioteca_usuario (
    ...
    status_biblioteca_usuario nvarchar(20) not null,
    pagina_biblioteca_usuario int not null,
    id_usuario int not null,
    id_livro int not null,
    constraint fk_bibliotecausuario_idusuario
        foreign key (id_usuario) references usuario(id_usuario),
    constraint fk_bibliotecausuario_idlivro
        foreign key (id_livro) references livro(id_livro),
...
create table lista_desejo (
    ...
    id_usuario int not null,
    id_livro int not null,
    constraint fk_listadesejo_idusuario
        foreign key (id_usuario) references usuario(id_usuario),
    constraint fk_listadesejo_idlivro
        foreign key (id_livro) references livro(id_livro),
...
create table avaliacao (
    ...
    comentario_avalicao nvarchar(1000),
    id_usuario int not null,
    id_livro int not null,
    constraint fk_avaliacao_idusuario
        foreign key (id_usuario) references usuario(id_usuario),
    constraint fk_avaliacao_idlivro
        foreign key (id_livro) references livro(id_livro),
...
create table cartao (
    ...
    id_usuario int not null,
    constraint fk_cartao_idusuario
        foreign key (id_usuario) references usuario(id_usuario)
);
...
create table boleto (
    ...
    status_boleto nvarchar(20) not null
);
...
create table pagamento_cartao (
    ...
    constraint fk_pagamentocartao_pagamento
        foreign key (id_pagamento_venda) references pagamento_venda(id_pagamento_venda),
    constraint fk_pagamentocartao_cartao
...
create table pagamento_boleto (
    ...
    constraint fk_pagboleto_pagamento
        foreign key (id_pagamento_venda) references pagamento_venda(id_pagamento_venda),
    constraint fk_pagboleto_boleto
...
create table pagamento_pix (
    ...
    id_pagamento_venda int not null unique,
    id_pix int not null,
    constraint fk_pagpix_pagamento
        foreign key (id_pagamento_venda) references pagamento_venda(id_pagamento_venda),
    constraint fk_pagpix_pix
...
create table venda (
    ...
    status_venda nvarchar(20) not null,
    id_usuario int not null,
    id_pagamento_venda int not null unique,
    constraint fk_venda_idusuario
        foreign key (id_usuario) references usuario(id_usuario),
    constraint fk_venda_idpagamentovenda
        foreign key (id_pagamento_venda) references pagamento_venda(id_pagamento_venda)
);
...
create table item_venda (
    ...
    preco_item_venda decimal(10, 2) not null default 0,
    id_livro int not null,
    id_venda int not null,
    constraint fk_itemvenda_idlivro
        foreign key (id_livro) references livro(id_livro),
    constraint fk_itemvenda_idvenda
...
create table cargo (
    ...
    nivel_cargo nvarchar(20) not null,
    salario_base decimal(10, 2) not null default 0,
    id_setor int not null,
    constraint fk_cargo_idsetor
...
create table funcionario (
    ...
    status_funcionario nvarchar(20) not null,
